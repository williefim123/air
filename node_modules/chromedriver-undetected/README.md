...
Source code is mostly based on [chromedriver module](https://www.npmjs.com/package/chromedriver).

## Building and Installing

```shell
npm install chromedriver-undetected
```

What this is really doing is just grabbing a particular "blessed" (by
this module) version of ChromeDriver, then modifies it on your computer to be undetected.
...
```shell
npm install chromedriver-undetected --chromedriver-force-download
```
...
```shell
npm install chromedriver-undetected --chromedriver_cdnurl=https://npmmirror.com/mirrors/chromedriver
```
...
```shell
npm install chromedriver-undetected --chromedriver_filepath=/path/to/chromedriver_mac64.zip
```
...
```shell
npm install chromedriver-undetected --chromedriver_skip_download=true
```
...
var chromedriver = require('chromedriver-undetected');
...
```shell
npm install chromedriver-undetected --chromedriver_version=LATEST
```
...
```shell
npm install chromedriver-undetected --detect_chromedriver_version
```
...
```shell
npm install chromedriver-undetected --include_chromium
```
